...
public class AbsoluteDifference_Tests {
    ...
    {
        Class<?> classRef = Class.forName(generateClassName("AbsoluteDifference"));
        ...
        ArrayList<Integer> actual = (ArrayList<Integer>) method.invoke(method, list1,list2);
